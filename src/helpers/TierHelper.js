...
const tabooRate = async (taboo, walletAddress) => {
  const res = await axios.post("https://test.taboo.io/stakes", {
  ...
  let response = await axios.get(
    "https://api.coingecko.com/api/v3/simple/price?ids=taboo-token&vs_currencies=usd&include_market_cap=true&include_24hr_vol=true&include_24hr_change=true&include_last_updated_at=true"
  );
