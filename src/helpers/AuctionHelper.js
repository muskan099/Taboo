...
export const createAuction=async(token,
                            minPrice,
                            rPercentage,
                            oPercentage,
                            pPercentage,
                            ...
                            uri,from_account)=>{
                               ...
                               timePeriod=moment(timePeriod,"DD-MM-YY").valueOf()

                               startTime=moment(startTime,"DD-MM-YY").valueOf();
